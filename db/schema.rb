...
ActiveRecord::Schema.define(version: 20151022194923) do
  ...
  create_table "projects", force: :cascade do |t|
    ...
    t.text     "wanted",      limit: 255,                 null: false
  ...
  add_index "roles", ["user_id", "project_id"], name: "index_roles_on_user_id_and_project_id", unique: true, using: :btree
